...
client.on('message', msg => {
  if (msg.content.toLowerCase() === 'aferin zeykat') {
    msg.reply('Sağol babuş eywallah ');
  }
});

client.on('message', msg => {
  if (msg.content.toLowerCase() === 'zeykat') {
    msg.reply('Efendim Babuş');
  }
});

client.on('message', msg => {
  if (msg.content.toLowerCase() === 'nasılsın') {
    msg.reply('İyiyim Babuş ^^ Sen nasılsın');
  }
});

client.on('message', msg => {
  if (msg.content.toLowerCase() === 'z!coffindance') {
    msg.reply('https://tenor.com/view/mati-bodoh-bangang-keranda-menari-gif-16794403');
  }
});

client.on('message', msg => {
  if (msg.content.toLowerCase() === 'z!bruh') {
    msg.reply('https://tenor.com/view/bruh-gif-5156041');
  }
});
...
client.on('message', msg => {
  if (msg.content.toLowerCase() === 'prefix') {
    msg.reply('Prefixim `z!` ');
  }
});

client.on('message', msg => {
  if (msg.content.toLowerCase() === 'z!tümkomutlar') {
    msg.reply('`1vs1` , `afewlater` , `alkış` , `alıntıla` , `ara155` , `atasözü` , `atış` , `avatar` , `ayrıl` , `azerbaycan` , `aşkölçer` , `balıktut` , `banner-yazı` , `başvuru` , `beşiktaş` , `boks` , `botkontrol` , `botkoruması` , `botun-pingi` , `bravery` , `bulanık` , `burç` , `dalgageç` , `dans` , `davet-sıralaması` , `davet-takip` , `davet` , `davetoluştur` , `dcdekiyıkık` , `desteaç` , `desteksunucu` , `dm-duyuru` , `ekranpaylaş` , `emoji-yükle` , `espri` , `event` , `fake-mesaj` , `fbi` , `fenerbahçe` , `galatasaray` , `gelişmiş-duyuru` , `güvenlik` , `haksızmıyım` , `hapishane` , `hava durumu` , `herkese-rol-ver` , `herkesten-rol-al` , `icon` , `idbakma` , `ilginç-bilgi` , `instagram` , `istatistik` , `kafasalla` , `kafasınasık` , `kanal-koruma` , `kapaklaflar` , `kartal` , `kasaaç` , `kayıt-kanal` , `kayıt-log` , `kayıt-rol` , `kayıt` , `kick` , `kilit` , `kitap-ara` , `komutlar` , `kralol` , `kullanıcı-ismi` , `kullanıcıbilgi` , `link-kısalt` , `manzara` , `mesaj-döndür` , `mesaj-sabitleme` , `metin kanal aç` , `mod-log-ayarla` , `odayaçek` , `otorol-kanal` , `otorol` , `oylama` , `rastgele-şifre` , `reklam taraması` , `reklam-engelleme` , `rip` , `rol bilgi` , `rol-koruma` , `roller` , `saat` , `sayaç-ayarla` , `sayaç-sıfırla` , `server-icon` , `ses kanal aç` , `sesli-say` , `seviye-ayarlar` , `seviye` , `sigara` , `sor` , `soygunyap` , `spoiler` , `spofity` , `steam` , `stres-çarkı` , `sunucu-ismi-değiştir` , `sunucu-resmi` , `sunucu-sayaç` , `sunucu-yedek-al` , `tarih` , `tavsiye` , `taş-kağıt-makas` , `tekerleme` , `temizle` , `toplu-ban-kaldır` , `trump` , `türk` , `unban-all` , `wasted` , `winner` , `yapımcım` , `yardım` , `yaz` , `yazdır` , `yazı-tura` , `youtube-arama` , `zar-at` , `zıtrenk` , `çekiliş` , `çeviri` , `özelden-yaz` , `üyedurum` , `şanslısayı` , `şekilli-duyuru`');
  }
});
...
client.on('message', msg => {
  if (msg.content.toLowerCase() === 'kötüyüm') {
    msg.reply('Senin için eğlence komutlarım var! 【z!eğlence】 ');
  }
});

client.on('message', msg => {
  if (msg.content.toLowerCase() === 'z!zeykat') {
    msg.reply('Bu komut geliştiriliyor!');
  }
});

client.on('message', msg => {
  if (msg.content.toLowerCase() === 'z!davet') {
    msg.reply('Davet Komutları :`z!davet-takip , z!davet-sıralaması , z!davetoluştur` ');
  }
});
...
client.on('message', msg => {
  if (msg.content.toLowerCase() === 'z!thuglife') {
    msg.reply('https://tenor.com/view/thug-life-gif-14421881');
  }
});

client.on('message', msg => {
  if (msg.content.toLowerCase() === 'z!noluyoaq') {
    msg.reply('https://tenor.com/view/noluyoburda-gif-17993706');
  }
});


client.on('message', msg => {
  if (msg.content.toLowerCase() === 'z!ricardomilos') {
    msg.reply('https://tenor.com/view/flick-esfand-esfandtv-ricardo-milos-ricardo-flick-gif-13730968');
  }
});
 ...
 channel.setParent(message.guild.channels.find(channel => channel.name === "✮ ▬  ▬ Duyuru Kanalları▬  ▬ ✮")));
  ...
  .then(c => {
    ...
    c.overwritePermissions(role, {
       ...
       message.guild.owner.send("Gerekli Herşey Kuruldu Rahatına Bak! **ZS  Bot'u tercih ettiğiniz için teşekkürler :D**")
...
client.on("guildMemberRemove", async member => {
 ...
 .setColor("RED")
  ...
  try {
    ...
    giriscikiskanali.send(`:negative_squared_cross_mark: :loudspeaker: 📤 ${member.user.tag}, aramızdan ayrıldı, \**${sayac[member.guild.id].sayi}\**kişi olmamıza \**${sayac[member.guild.id].sayi - member.guild.memberCount}\** kişi kaldı! :negative_squared_cross_mark: `);
...
client.on("guildMemberAdd", async member => {
 ...
 .setColor("GREEN")
  ...
  try {
    let giriscikiskanalID = giriscikis[member.guild.id].kanal;
    let giriscikiskanali = client.guilds.get(member.guild.id).channels.get(giriscikiskanalID);
    giriscikiskanali.send(`:ballot_box_with_check: :loudspeaker: 📥 ${member.user.tag}, aramıza katıldı **${sayac[member.guild.id].sayi}** kişi olmamıza **${sayac[member.guild.id].sayi - member.guild.memberCount}** kişi kaldı! :ballot_box_with_check: ` );
  } catch (e) { // eğer hata olursa bu hatayı öğrenmek için hatayı konsola gönderelim.
    return console.log(e)
  }
...
.setTitle(`ZS | Bilgilendirme`)
.setTimestamp()
.setColor("GREEN")
.setDescription(`Beni Sunucuna Eklediğin İçin Teşekkür Ederim \n Sana En İyi Şekilde Hizmet Edeceğim.\n Eğer Bir Sorunla Karşılaşırsan Destek Sunucuma Gel  https://discord.gg/g8RPaT5 \n Komutlarımız için **z!yardım** komutunu kullanınız.`)
...
client.on("roleCreate", async (rolee, member, guild) => {
  ...
  if (rolkoruma == "acik") {
    ...
    const embed = new Discord.RichEmbed()
      .setDescription(
        "Sunucunuzda yeni bir rol oluşturuludu! fakat geri silindi! (ZS Rol Koruma Sistemi)"
      )
      .setColor("BLACK");
...
let add = client.channels.get("741706793658351697")
...
let remove = client.channels.get("741706793658351697")
...
client.on("channelCreate", async (channel, member, guild) => {
  ...
  if (kanal == "acik") {
    ...
    const embed = new Discord.RichEmbed()
      .setDescription(
        "Sunucunuzda yeni bir kanal oluşturuludu! fakat geri silindi! (ZS Kanal Koruma Sistemi) "
      )
      .setColor("BLACK");
              ...
              if (reklam.some(word => msg.content.toLowerCase().includes(word))) {
                try {
                  if (!msg.member.hasPermission("MANAGE_GUILD")) {
                    ...
                    let embed = new Discord.RichEmbed()
                    .setColor(0xffa300)
                    .setFooter('ZS  -|-  Reklam engellendi.', client.user.avatarURL)
                    .setAuthor(msg.guild.owner.user.username, msg.guild.owner.user.avatarURL)
                    .setDescription("ZS Reklam sistemi, " + `***${msg.guild.name}***` + " adlı sunucunuzda reklam yakaladım.")
...
if (!modlogkanal) return;
	if (channel.type === "text") {
				...
				.setFooter(`ZS | Mod-Log Sistemi Kanal ID: ${channel.id}`)
        ...
        client.channels
          ...
          .send(
            message.member.user.username + 
              ...
              lvl + 
              "` Tebrikler!   https://tenor.com/view/dabjultsu-levelup-gif-16298509 **"
          );
...
.then(channel =>
 channel.setParent(message.guild.channels.find(channel => channel.name === "Server Panel")));
  message.channel.send("ZS Bot Bilgi Paneli Ayarlandı!")
