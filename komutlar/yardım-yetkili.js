...
exports.run = (client, message, args) => {
    ...
    .setColor('GOLD')
    .setAuthor(`ZS | Yetkili Komutları`, client.user.avatarURL) 
      .setDescription('**[destek sunucum için tıkla](https://discord.gg/aedtftG)**')
.setThumbnail(client.user.avatarURL)
      .addField('**Genel**', '`kick`, `oylama`, `reboot`, `duyuru`, `çekiliş`, `isim`, `fakemesaj`, `uyarı`, `sabitle`, `partner`, `botkontrol`,`mute`')
      .addField('**Gerekli Komutlar**', '`otorol-sistemi`, `sayaç-sistemi`, `kayıt-sistemi`, `seviye-sistemi`, `sunucu-sistemi`, `özelgülegüle`, özelhoşgeldin`')
