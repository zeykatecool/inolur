...
exports.run = async(client, message, args) => {
  ...
  if (!args[0]) return message.channel.send(`:no_entry: Reklam Filtresini Ayarlamak İçin \`z!reklam-engelleme aç\` | Kapatmak İstiyorsanız \`z!reklam-engelleme kapat\` Yazabilirsiniz`)
  if (args[0] !== 'aç' && args[0] !== 'kapat') return message.channel.send(`:no_entry: Reklam Filtresini Ayarlamak İçin \`z!reklam-engelleme aç\` | Kapatmak İstiyorsanız \`z!reklam-engelleme kapat\` Yazabilirsiniz`)
