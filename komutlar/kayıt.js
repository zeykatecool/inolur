...
exports.run = async (client, message, args) => {
  ...
  if(samet == null) return message.channel.send('Kayıt Sistemi eklemek için <`z!kayıt-rol @rol`/`z!kayıt-kanal #kanal`/`z!kayıt-log #kanal`> şeklinde Ayarlıya bilirsiniz. ');
 ...
 /* client.on('',{
  ...
  message.channel.send(`${message.author} Sunucuya Kayıt oldun :)`)
